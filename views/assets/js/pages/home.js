...
window.addEventListener("load", () => {
    ...
    const headerTransitionTimeSeconds = parseInt(document.querySelector("body > div.container > ul.block_list > .block.welcome > .content > div.text > div.top > div.right > h1.catchy_header > span.word_container:last-child > span.word_animated").style.transitionDelay.split("s")[0]) + 0.6;

    // fire social url and text animations after header animation finishes
    setTimeout(() => {
        // animate social urls
        const socialURLsElement = document.querySelector("body > div.container > ul.block_list > .block.welcome > .content > div.text > div.top > div.right > ul.social_links");
